...
readonly class EventCreateHandler
{
    ...
    public function handle(EventCreate $command): void
    {
    ...
    private function checkAvailability(EventCreate $command, Spaces $space): bool
    {
